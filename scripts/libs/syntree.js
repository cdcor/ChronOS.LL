// By Miles Shang <mail@mshang.ca>, modifications by Christopher Cordisco for use in this project.
// MIT license
...
function go(str, font_size, term_font, nonterm_font, vert_space, hor_space, color, term_lines) {	
	...
	//ctx.fillRect(0, 0, width, height); // Modded to have a transparent background
...
// There is a subtle error in this program which require vert_space to be a global variable,
// I'll just add this for now until I get a chance to investigate. - Chris
var vert_space = 30;

window.buildSyntaxTree = go;
